...
<div class="col s12 m12 l12">
    ...
    <div class="row">
            <h3 class="center-align">Hojas</h3>
    </div>
    <div class="row">
        <form action="documentos.php" method="post">
          <div class="row">
            ...
            <div class="input-field col s2 m2 l2">
              <input type="submit" class="btn-large " style="margin-top:-.2em;" value="Ver Hojas">
            </div>
          </div>
        </form>
      ...
      <div class="row"id="documentos">
        ...
        while ($row = mysql_fetch_row($constula)){
          echo '<tr>
            ...
            <td>'.$row[2].'</td>
            <td></td>
            <td><a class="botnnva" href="verHoja.php?id_dcto='.$row[0].'" style="padding:.3em 1.2em !important;" >Ver</a></td>
